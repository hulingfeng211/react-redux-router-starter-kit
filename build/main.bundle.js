...
/***/ function(module, exports, __webpack_require__) {
	...
	setInterval(function () {
		(0, _reactDom.render)(_react2.default.createElement(_commentBox2.default, { time: new Date() }), (0, _jquery2.default)('#react-content')[0]);
	}, 500);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Comment = _react2.default.createClass({
	    ...
	    rawMarkup: function rawMarkup() {
	        var rawMarkup = (0, _marked2.default)(this.props.children.toString(), {
	            sanitize: true
	        });
	        return {
	            __html: rawMarkup
